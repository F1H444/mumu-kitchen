                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="row card-header py-3 justify-content-between">
                                <div class="col-6">
                                    <h5 class="m-0 font-weight-bold text-primary">Pesanan Selesai</h5>
                                </div>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <a href="/dashboard/invoice/cetak_pdf/{{ $value->id }}"
                                                        class="btn btn-danger me-2"><i class="fas fa-file-alt"></i> </a>
                                                    <form
                                                        action="{{ url('/dashboard/pesananselesai/' . $value->id . '/update') }}"
