                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="row card-header py-3 justify-content-between">
                                <div class="col-6">
                                    <h5 class="m-0 font-weight-bold text-primary">Pesanan Dalam Pengiriman</h5>
                                </div>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <form
                                                        action="{{ url('/dashboard/pesanandalampengiriman/' . $value->id . '/kembalidiproses') }}"
                                                        method="POST" class="d-flex">

                                                        @csrf

                                                        <input type="hidden" name="status" value="pesanandiproses">

                                                        <button class="btn btn-warning me-2" class="btn btn-primary ">
                                                            <i class="fas fa-arrow-left"></i></button>

                                                    </Form>
                                                    <form
                                                        action="{{ url('/dashboard/pesanandalampengiriman/' . $value->id . '/updatedikirim') }}"
                                                        method="POST" class="d-flex">

                                                        @csrf

                                                        <input type="hidden" name="status" value="pesananselesai">
