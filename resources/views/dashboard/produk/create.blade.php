    ...
    <div class="container-fluid px-4 py-4">
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                ...
                <h1 class="h3 mb-0 text-white font-weight-bold">Tambah <span class="text-primary">Produk Baru</span></h1>
            </div>
                    ...
                    <div class="card-body p-lg-5">
                        <form action="{{ route('produk.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="number" name="stok"
                                                ...
                                                placeholder="Contoh: 100" value="{{ old('stok') }}" required>
                                            @error('stok')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" rows="5"
                                            placeholder="Tuliskan deskripsi lengkap produk..." required>{{ old('deskripsi') }}</textarea>
                                        @error('deskripsi')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="image-upload-wrapper mb-3">
                                        ...
                                        <label for="productImage"
                                            class="image-preview-container d-flex flex-column align-items-center justify-content-center border border-2 border-dashed rounded-4 p-4 cursor-pointer"
                                            id="imagePreview">
                                            <i class="fas fa-cloud-upload-alt fa-3x text-primary mb-3"></i>
                                            <span class="fw-bold text-white mb-1">Klik untuk Upload</span>
                                    ...
                                    <div class="alert alert-info bg-opacity-10 border-0 rounded-3 small">
                                        <i class="fas fa-info-circle me-2"></i> Tips: Gunakan gambar dengan rasio 1:1 untuk
                                        tampilan terbaik di katalog produk.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-center justify-content-end gap-3">
                                ...
                                <button type="submit" class="btn btn-lg btn-primary px-5 fw-bold">Simpan Produk</button>
                            </div>
                        </form>
                    </div>
                </div>
